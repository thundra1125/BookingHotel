    ...
    <>
      ...
      <form className="p-5" onSubmit={onSubmitHandler}>
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <label htmlFor="first-name" className="mr-2">
            First Name*
          </label>
          ...
          <input
            ...
            onChange={(e) =>
              setBooking({
                ...booking,
                full_name: [e.target.value, booking.full_name[1]],
              })
            }
          />
        </div>
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between pt-2">
          <label htmlFor="last-name" className="mr-2">
            Last Name*
          </label>
          <input
            id="last-name"
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between pt-2">
          <label htmlFor="expiry-date" className="mr-2">
            Expiry Date*
          </label>
          <div className="w-full lg:w-3/4">
            ...
            <input
              type="number"
              min={new Date().getFullYear().toString().substr(2, 2)}
              max={
                parseInt(new Date().getFullYear().toString().substr(2, 2)) + 20
              }
              maxLength="2"
              onInput={maxLengthCheck}
              className="p-2 border border-gray-600 mt-2 md:w-2/12"
