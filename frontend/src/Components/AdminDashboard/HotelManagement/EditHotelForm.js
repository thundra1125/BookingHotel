    ...
    <div className="w-full md:w-6/12 xl:w-8/12 md:ml-5 bg-gray-200 p-5 rounded-sm  ">
      ...
      >
        ...
        <input
          ...
          className="p-2 w-full xl:w-1/2 border border-gray-400 focus:outline-none focus:border-black"
          value={hotel.star}
          onChange={(e) => setHotel({ ...hotel, star: e.target.value })}
        />
        ...
        <label htmlFor="map_coordinates" className="block mt-5 font-semibold">
          Map Coordinate:{" "}
        </label>
        ...
        <input
          ...
          onChange={(e) => setHotel({ ...hotel, x_coordinate: e.target.value })}
        />
        <label htmlFor="map_coordinates" className="block mt-5">
          Y Coordinate:{" "}
        </label>
        <input
          ...
          onChange={(e) => setHotel({ ...hotel, y_coordinate: e.target.value })}
        />
