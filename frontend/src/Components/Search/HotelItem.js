        ...
        <div className="md:w-1/4 relative text-sm">
          ...
          <div className="text-xs flex items-center justify-evenly absolute bottom-0 w-f p-2 rounded-tr-lg overflow-hidden">
            <div className="h-8 w-8 rounded-full border-2 border-gray-100 flex justify-center items-center z-10">
              <span className="text-gray-100 font-semibold">{rating[0]}</span>
            </div>
        ...
        <div className="p-5 md:w-3/4">
          ...
          <div className="mt-5">
            <div className="flex flex-col md:flex-row justify-between md:items-center">
              ...
              <Link
                to={`/hotel/${hotel.id}/room_search/check_in=${
                  criteria.check_in
                }&check_out=${criteria.check_out}&city=${criteria.city}&star=${
                  criteria.star === "" ? 0 : criteria.star.toString()
                }&min_price=${criteria.min_price}&max_price=${
                  criteria.max_price
                }`}
