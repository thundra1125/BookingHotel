  ...
  return (
    <section className="relative">
      ...
      <div className="mt-8 book flex flex-col justify-center items-center text-gray-100 z-20 w-10/12">
        ...
        <div className="bg-green-500 bg-opacity-75 mt-5 p-5 rounded-sm mx-auto text-gray-700 w-11/12 sm:w-9/12 md:w-8/12 lg:w-7/12 xl:w-9/12 font-sans">
          <div
        ...
        <Link
          className="font-sans text-center bg-green-600 text-white hover:bg-green-700 uppercase rounded-sm  px-12 py-4 shadow
                    hover:shadow-lg block mx-auto mt-2 xl:mt-0"
          to={`/search/check_in=${initSearchData.check_in}&check_out=${initSearchData.check_out}&city=${initSearchData.city}`}
        >
          Search
        </Link>
      </div>
